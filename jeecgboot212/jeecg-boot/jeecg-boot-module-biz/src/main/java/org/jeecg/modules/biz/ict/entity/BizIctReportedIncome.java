 ...
 */
@Data
@TableName("biz_ict_reported_income")
public class BizIctReportedIncome implements Serializable {
	...
	/**报收比例*/
	@Excel(name = "报收比例", width = 15)
	private java.math.BigDecimal reportedRate;
	/**报收日期*/
	@Excel(name = "报收日期", width = 15, format = "yyyy-MM-dd")
	@JsonFormat(timezone = "GMT+8",pattern = "yyyy-MM-dd")
    @DateTimeFormat(pattern="yyyy-MM-dd")
	private java.util.Date reportedDate;
	/**报收帐期*/
	@Excel(name = "报收帐期", width = 15)
