...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'ictContractNumber','costReportingRatio','costReportingDate','reportedAccountMonth','remark','createBy','createTime','updateBy','updateTime'))
      }
