...
<!--          <a-col :md="4" :sm="6">
            <a-form-item label="营销单位">
              <j-input placeholder="营销单位" v-model="queryParam.saleUnit"></j-input>
            </a-form-item>
          </a-col>-->
          <a-col :md="6" :sm="8" >
...
<!--    <bizIctProjectOpportunity-modal ref="modalForm" @ok="modalFormOk"></bizIctProjectOpportunity-modal>-->
  </a-card>
</template>
...
<script>
  ...
  /*import BizIctProjectOpportunityModal from './modules/BizIctProjectOpportunityModal'*/
...
/*          {
        ...
        url: {
          list: "/ict/bizIctProjectOpportunity/list",
          delete: "/ict/bizIctProjectOpportunity/delete",
          deleteBatch: "/ict/bizIctProjectOpportunity/deleteBatch",
          exportXlsUrl: "/ict/bizIctProjectOpportunity/exportXls",
          importExcelUrl: "ict/bizIctProjectOpportunity/importExcel",
        },
        dictOptions:{
        },
        tableScroll:{x :14*147+50}
      }
    },
    computed: {
