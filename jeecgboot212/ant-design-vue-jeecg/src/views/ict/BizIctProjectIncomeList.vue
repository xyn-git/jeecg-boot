...
<!--    <bizIctProjectIncome-modal ref="modalForm" @ok="modalFormOk"></bizIctProjectIncome-modal>-->
  </a-card>
</template>

<script>
  import { JeecgListMixin } from '@/mixins/JeecgListMixin'
/*  import BizIctProjectIncomeModal from './modules/BizIctProjectIncomeModal'*/
...
/*          {
        ...
        url: {
          list: "/ict/bizIctProjectIncome/list",
          delete: "/ict/bizIctProjectIncome/delete",
          deleteBatch: "/ict/bizIctProjectIncome/deleteBatch",
          exportXlsUrl: "/ict/bizIctProjectIncome/exportXls",
          importExcelUrl: "ict/bizIctProjectIncome/importExcel",
        },
        dictOptions:{
        },
